...
class DropzoneWidget(JinjaWidget):
    ...
    def __init__(self, post_url=None, max_file_size=None, max_files=10, add_remove_links=True, accepted_file_types=None,
                 param_name='file', submit_if_empty=True, submit_form=False, handle_flashes=False, style=None):
    ...
    def __call__(self, field, **kwargs):
        return super(DropzoneWidget, self).__call__(field, input_args=kwargs, options=self.options, style=self.style)
